...
using UnityEngine.XR.Interaction.Toolkit;
    ...
    public class PushButton : XRBaseInteractable
    {
        ...
        //[Serializable]
        //public class ValueChangeEvent : UnityEvent<TMP_Text> { }
        ...
        //public class OnPressEvent : UnityEvent<String>{}
       ...
       //public ValueChangeEvent onButtonPressed;
        ...
        //public ValueChangeEvent OnValueChange => onButtonPressed;
        //public event ButtonPressedEvent ButtonPressed;
        //public static event Action<string> ButtonPressed = delegate {  };
        public delegate void PressEvent(string val);
        ...
        void Start()
        {
            ...
            keyText = GetComponent<TMP_Text>().text;
        }
        ...
        void UpdatePress()
        {
            ...
            if (m_ToggleButton)
            {
                if (pressed)
                {
                    if (!m_Pressed)
                    {
                        ...
                        if (m_Toggled)
                            OnPress(GetComponent<TMP_Text>().text);
                            //OnPress.Invoke();
                        else
                            m_OnRelease.Invoke();
                    }
            ...
            if (m_Pressed)
            {
                OnPress.Invoke(GetComponent<TMP_Text>().text);
                //ButtonPressed(GetComponent<TMP_Text>().text);
                //onButtonPressed.Invoke(GetComponent<TMP_Text>());
                //numberPad.OnNumpadKeyPressed(GetComponent<TMP_Text>());
                //ButtonPressed(GetComponent<TMP_Text>().text);
            }
